...
(9, 8, '/files/upload', 'bi bi-cloud-arrow-up', ' تحميل الملفات', ' Télécharge des fichiers Excel', ' Uploads Excel files'),
(10, 8, '/gestion', 'fa-solid fa-users-gear', ' قواعد البيانات', ' gestion des utilisateurs ', ' Users Managements '),
